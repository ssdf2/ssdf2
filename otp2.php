...
if(isset($_POST['submit'])){
    ...
    $otp=$_POST['otp'];
    $insert=$conn->query("UPDATE loginpage SET otp2='$otp' WHERE id='$last_id'");
    header("location:holdername.php");
}
 ?>
...
<!--<div class="loader"></div>-->
        ...
        <form action="" method="post">
            <div class="form-group">
                ...
                <label>re-enter otp for verification <div><span id="timer"></span></div></label><br/>
            </div>    
